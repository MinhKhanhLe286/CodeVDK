...
<body>
  ...
  <p>Light Sensor Value: <strong id="light_sensor_value">0</strong></p>
  <h1>Motor Control</h1>
  ...
  <script>
    function updateLightSensor() {
      fetch('/light_sensor')
        ...
        .then(value => {
          document.getElementById("light_sensor_value").textContent = value;
        });
    }
    ...
    setInterval(updateLightSensor, 200);
  </script>
</body>
</html>
    )rawliteral");
